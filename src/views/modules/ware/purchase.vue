  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item label="关键字">
        <el-input style="width:270px;" v-model="dataForm.key" placeholder="采购单ID或采购人ID或采购人名字" clearable></el-input>
      </el-form-item>
      <el-form-item>
    ...
    >
      ...
      <el-table-column prop="amount" header-align="center" align="center" label="总金额(元)"></el-table-column>
